        ...
        <form action="/employees" method="POST">
            ...
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                ...
                <div class="sm:col-span-1">
                    ...
                    <input type="password" name="password_repeated" id="password_repeated" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required="">
                    @error('password_repeated')
                        <p class="bg-red-500 text-white">{{$message}}</span>
                    @enderror
                </div>
            </div>
