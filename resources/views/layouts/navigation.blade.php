<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <!-- Reservings -->
                    <x-nav-link :href="route('reservings.index')" :active="request()->routeIs('reservings.index')">
                        {{ __('Reservings') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('scores.index')" :active="request()->routeIs('scores.index')">
                        ...
                        @if(\Illuminate\Support\Facades\Auth::user()->role === 'Admin' || \Illuminate\Support\Facades\Auth::user()->role === 'Owner')
                            <x-nav-link
                                :href="route('uitslag.showall')"
                                :active="request()->routeIs('uitslag.showall')">
                                {{ __('Uitslag') }}
                            </x-nav-link>
                        @endif
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <!-- Rows (Admin/Owner Only) -->
            @if(\Illuminate\Support\Facades\Auth::user()->role === 'Admin' || \Illuminate\Support\Facades\Auth::user()->role === 'Owner')
                <x-responsive-nav-link :href="route('rows.index')" :active="request()->routeIs('rows.index')">
                    {{ __('Rows') }}
                </x-responsive-nav-link>
            @endif
            ...
            <!-- Reservings -->
            <x-responsive-nav-link :href="route('reservings.index')" :active="request()->routeIs('reservings.index')">
                {{ __('Reservings') }}
            </x-responsive-nav-link>
